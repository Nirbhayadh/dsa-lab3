...
class BSTTestCase(unittest.TestCase):
    ...
    def test_custom(self):
        ...
        # bsTree must be empty
        self.assertEqual(bsTree.size(), 0)    
        # Finding smallest and largest keys of an empty BST
        self.assertEqual(bsTree.smallest(),None)   
        self.assertEqual(bsTree.largest(),None)    
        # Removing key, not present in the Tree
        bsTree.remove(10)
        self.assertEqual(bsTree.size(), 0)
        self.assertEqual(bsTree.search(10), False)
        # Adding same key-pair twice
        bsTree.add(15, "Value for 15")
        bsTree.add(15, "Value for 15")
        # Size of bsTree must be 1
        self.assertEqual(bsTree.search(15), "Value for 15")
